...
const Layout = ({ children }: any) => {
  return (
    <div className="absolute h-full w-full">
      <div id="mobile-nav" className="absolute z-40 h-full w-full xl:hidden">
        <div
          className="fixed inset-0 h-full w-full bg-gray-800 opacity-50"
        ></div>
        <div className="absolute left-0 top-0 z-20 z-40 h-full w-64 flex-col justify-between bg-white shadow transition duration-150 ease-in-out">
            ...
            <div className="overflow-y-auto px-6 pt-4">
              <div className="flex items-center justify-between">
                <div aria-label="Home" role="img" className="flex items-center">
                  ...
                  <p className="text-bold md:text2xl pl-3 text-base text-gray-800">
                    The North
                  </p>
                </div>
                <button
                  id="cross"
                  className="hidden rounded text-gray-800 focus:outline-none focus:ring-2 focus:ring-gray-800 focus:ring-offset-2"
                >
                  <svg
              ...
              <ul className="f-m-m">
                <li className="pt-8 text-white">
                  <div className="flex items-center">
                    ...
                    <a
                      className="ml-3 text-lg text-indigo-500"
                    >
                      Dashboard
                    </a>
                  </div>
                </li>
                <li className="pt-8 text-gray-700">
                  <div className="flex items-center">
                    <div className="flex items-center">
                      <div className="h-5 w-5 md:h-6 md:w-6">
                        <svg
                    ...
                    <button
                      id="chevronup"
                      className="ml-4 rounded focus:outline-none focus:ring-2 focus:ring-gray-500"
                    >
                      <svg
                    ...
                    <button
                      id="chevrondown"
                      className="ml-4 hidden rounded focus:outline-none focus:ring-2 focus:ring-gray-500 "
                    >
                      <svg
                  ...
                  <div id="list" className="hidden">
                    <ul className="my-3">
                      <li className="py-2 px-6 text-sm text-indigo-500">
                        <a href=""> Best Sellers </a>
                      </li>
                      <li className="py-2 px-6 text-sm text-gray-800 hover:text-indigo-500">
            ...
            <div className="w-full">
              <div className="mb-4 flex w-full justify-center px-6">
                <div className="relative w-full">
                  <div className="absolute inset-0 m-auto ml-4 h-4 w-4 text-gray-600">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                  ...
                  <input
                    className="w-full rounded bg-gray-100 bg-gray-100 py-2 pl-10 text-sm text-gray-500 placeholder-gray-600 focus:outline-none"
                    type="text"
                    placeholder="Search"
                  />
                </div>
      ...
      <nav className="mx-auto w-full bg-white shadow">
        <div className="container mx-auto flex h-16 items-center justify-between px-6 lg:items-stretch">
          <div className="flex h-full items-center">
            ...
            <ul className="hidden h-full items-center pr-12 xl:flex">
              <li className="flex h-full cursor-pointer items-center border-b-2 border-indigo-700 text-sm tracking-normal text-indigo-700 hover:text-indigo-700">
                <a href=""> Dashboard</a>
              </li>
              <li className="text-gry-800 mx-10 flex h-full cursor-pointer items-center text-sm tracking-normal hover:text-indigo-700">
                <a href="">Products</a>
              </li>
              <li className="text-gry-800 mr-10 flex h-full cursor-pointer items-center text-sm tracking-normal hover:text-indigo-700">
                <a href="">Performance</a>
              </li>
              <li className="flex h-full cursor-pointer items-center text-sm tracking-normal text-gray-800 hover:text-indigo-700">
          ...
          <div className="hidden h-full items-center justify-end xl:flex">
            <div className="flex h-full w-full items-center">
              <div className="flex h-full w-full items-center border-r pr-12">
                <div className="relative w-full">
                  <div className="absolute inset-0 m-auto ml-3 h-4 w-4 text-gray-600">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      className="icon icon-tabler icon-tabler-search"
                      width="16"
                  ...
                  <input
                    className="w-56 rounded border border-gray-100 bg-gray-100 py-2 pl-8 text-sm text-gray-500 placeholder-gray-600 focus:border-indigo-700 focus:outline-none"
                    type="text"
                    placeholder="Search"
                  />
                </div>
              ...
              <div className="flex h-full w-full">
                <div className="flex h-full w-32 cursor-pointer items-center justify-center border-r text-gray-600">
                  <a
                ...
                >
                  ...
                  <ul className="absolute left-0 z-40 mt-64 hidden w-40 rounded border-r bg-white p-2 shadow">
      ...
      <div className="container my-6 mx-auto flex flex-col items-start justify-between border-b border-gray-300 px-6 pb-4 lg:my-12 lg:flex-row lg:items-center">
        <div>
          <h4 className="text-2xl font-bold leading-tight text-gray-800">
            User Profile
          </h4>
          <ul className="mt-3 flex flex-col items-start text-sm text-gray-600 md:flex-row md:items-center">
            <li className="mr-3 mt-3 flex items-center md:mt-0">
              <span className="mr-2">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
            ...
            <li className="mt-3 flex items-center md:mt-0">
              <span className="mr-2">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
        ...
        <div className="mt-6 lg:mt-0">
          <button className="mx-2 my-2 rounded bg-white px-6 py-2 text-sm text-indigo-700 transition duration-150 ease-in-out hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-indigo-700">
            Back
          </button>
          <button className="rounded border bg-indigo-700 px-8 py-2 text-sm text-white transition duration-150 ease-in-out hover:bg-indigo-600 focus:outline-none focus:ring-2 focus:ring-indigo-700 focus:ring-offset-2">
            Edit Profile
          </button>
        </div>
      </div>
