...
const Layout = ({ children }: any) => {
  ...
  return (
    <div className="w-full h-full bg-brand-black-01">
    <div className="flex flex-no-wrap">
        {/* Sidebar starts */}
        <div className="absolute lg:relative w-[50px] h-screen shadow bg-brand-black-02 hidden lg:block">
            ...
            <ul aria-orientation="vertical" className="py-6 flex flex-col items-center">
                <li className="cursor-pointer text-white text-sm leading-3 tracking-normal pb-4 pt-5 text-indigo-700 focus:text-indigo-700 focus:outline-none">
                ...
                <li className="cursor-pointer text-gray-600 text-sm leading-3 tracking-normal mb-4 py-2 hover:text-indigo-700 focus:text-indigo-700 focus:outline-none">
                    <div className="flex items-center">
        ...
        <div className={show ? "w-full h-full absolute z-40  transform  translate-x-0 " : "   w-full h-full absolute z-40  transform -translate-x-full"} id="mobile-nav">
            ...
            <div className="absolute z-40 sm:relative w-64 md:w-96 shadow pb-4 bg-brand-black-02 lg:hidden transition duration-150 ease-in-out h-full">
        ...
        <div className="w-full">
            <nav className="h-16 flex items-center lg:items-stretch justify-end lg:justify-between bg-brand-black-01 shadow relative z-10">
